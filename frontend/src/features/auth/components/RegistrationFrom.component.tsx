		...
		<Box sx={{ border: 1, padding: 2, borderColor: '#cccccc', width: '350px' }}>
			<form onSubmit={onSubmitHandler}>
				<Grid container direction="column" justifyContent="flex-start">
					...
					<TextField value={confirmPassword} onChange={confirmPasswordChangeHandler} onBlur={confirmPasswordBlurHandler} error={confirmPassword.length > 0 && password !== confirmPassword} helperText={confirmPassword.length > 0 && password !== confirmPassword ? "Passwords must match" : ""} type="password" name="name" id="confirmPassword" variant="outlined" size="small" />
